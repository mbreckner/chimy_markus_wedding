export const de = {
    ...
    travel: {
        ...
        destinations: [
            {
                number: "01", flag: "Vor der Hochzeit · Sambia", name: "Lusaka & Sambia",
                duration: "Mindestens eine Woche",
                desc: "Wir werden mindestens eine Woche vor der Hochzeit in Lusaka sein. Kommt früher an, erkundet das Land, verbringt Zeit miteinander und stimmt euch auf die Feierlichkeiten ein. Die Victoria Falls sind ebenfalls einen Besuch wert.",
                tags: ["Lusaka", "Victoria Falls"], tbc: [],
            },
            {
                number: "02", flag: "Nach der Hochzeit · Tansania", name: "Serengeti",
                duration: "Ca. 5 Tage",
                desc: "Safari in einem der bekanntesten Nationalparks Afrikas. Endlose Ebenen, außergewöhnliche Tierwelt und die große Migration.",
                tags: ["Safari", "Tierwelt"], tbc: ["Flüge noch offen"],
            },
            {
                number: "03", flag: "Nach der Hochzeit · Tansania", name: "Ngorongoro",
                duration: "Ca. 3 Tage",
                desc: "Das Ngorongoro-Hochland — Massai-Region, Kultur und ein UNESCO-Weltnaturerbe mit vulkanischem Krater voller Wildtiere.",
                tags: ["Massai-Kultur", "Hochland"], tbc: ["Details noch offen"],
            },
            {
                number: "04", flag: "Nach der Hochzeit · Tansania", name: "Sansibar",
                duration: "Ca. eine Woche",
                desc: "Strand und Erholung auf der Gewürzinsel. Weißer Sand, türkisfarbenes Wasser und die verwinkelten Gassen von Stone Town.",
                tags: ["Strand", "Erholung"], tbc: ["Unterkunft noch offen"],
            },
            {
                number: "05", flag: "Optional · Tansania", name: "Kilimandscharo",
                duration: "Ca. eine Woche",
                desc: "Für Abenteuerlustige — Trekking auf Afrikas höchsten Gipfel. Völlig optional und nur für diejenigen, die mitmachen möchten.",
