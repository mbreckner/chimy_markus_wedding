export const de = {
    ...
    travel: {
        ...
        note: "Für jeden Abschnitt könnt ihr angeben, ob ihr dabei seid — scrollt einfach nach unten und stimmt ab. Das hilft uns, die Gruppengrößen einzuschätzen, etwa für Transfers oder Wanderungen am Kraterrand. Wir aktualisieren diese Seite laufend — Flüge, Unterkunft und Aktivitäten bucht jeder eigenständig.",
        voting: {
            sectionLabel: "Bist du dabei?",
            countMeIn: "Bin dabei",
            stillDeciding: "Vielleicht dabei",
            removeVote: "Abstimmung entfernen",
            notYou: "Nicht {name}?",
            nameLabel: "Dein Name",
            namePlaceholder: "Dein Name",
            nameSubmit: "Weiter",
            conflictNotice: "Für \"{name}\" gibt es bereits eine Abstimmung. Bist du das?",
            conflictYes: "Ja, meine Abstimmung aktualisieren",
            conflictNo: "Anderen Namen verwenden",
            countMeInList: "Bin dabei",
    ...
    qa: {
        ...
        errorMsg: "Etwas ist schiefgelaufen — bitte versucht es erneut oder meldet euch direkt bei uns.",
    },
    guestbook: {
