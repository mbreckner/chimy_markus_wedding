    ...
    travel: {
        ...
        destinations: [
            ...
            },
            {
                ...
                highlights: [],
                itinerary: [
                    { date: "15. Sep", title: "Flug: Lusaka → Dar es Salaam", detail: "LUS → DAR · 15:05–18:25 · ca. CHF 203 p.P.", status: "booked", note: "" },
                    { date: "15.–16. Sep", title: "Nacht in Dar es Salaam", detail: "", status: "open", note: "" },
                    { date: "16. Sep", title: "Flug: Dar es Salaam → Serengeti", detail: "DAR → SEU via Arusha · 08:00–10:45 · ca. CHF 158 p.P.", status: "booked", note: "" },
                    { date: "16.–20. Sep", title: "Safari-Lodge, Seronera", detail: "3 volle Tage im zentralen Seronera-Gebiet", status: "open", note: "" },
                ],
            ...
            },
            {
                ...
                tbc: [],
                itinerary: [
                    { date: "20. Sep", title: "Fahrt: Seronera → Karatu", detail: "~4–5 Std. · Wildtiere auf dem Weg · bei einer Gruppe können wir Jeeps teilen, um die Kosten pro Person zu senken", status: "open", note: "" },
                    { date: "20.–22. Sep", title: "Patamu Restaurant, Lodge & Safaris, Karatu", detail: "2 Nächte im Hochland", status: "booked", note: "" },
                    { date: "21. Sep", title: "Empakaai-Krater-Wanderung", detail: "Ganztages-Wanderung · Abstieg in die Caldera · Kratersee & Aussicht über das Rift Valley", status: "open", note: "Eine ganztägige Wanderung hinunter in einen uralten Krater — steile Pfade durch Wald, die sich zu einem Sodasee öffnen, der Heimat grosser Flamingo-Schwärme ist, mit Blick auf den Vulkan Ol Doinyo Lengai und das Grosse Rifttal." },
                    ...
                    { date: "22. Sep", title: "Fahrt nach Arusha + Flug nach Sansibar", detail: "Details folgen · gemeinsamer Transport für Gruppen kann organisiert werden", status: "open", note: "" },
                ],
            },
            {
                number: "04",
