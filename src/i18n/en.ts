export const en = {
    ...
    travel: {
        ...
        destinations: [
            { number: "01", flag: "Before the wedding · Zambia", name: "Lusaka & Zambia", duration: "At least one week", desc: "We'll be in Lusaka for at least a week before the wedding. Come early, explore the country, spend time together and ease into the celebrations. Victoria Falls is also worth a visit.", tags: ["Lusaka", "Victoria Falls"], tbc: [] },
            { number: "02", flag: "After the wedding · Tanzania", name: "Serengeti", duration: "Around 5 days", desc: "Safari in one of Africa's most iconic national parks. Endless plains, extraordinary wildlife, and the great migration.", tags: ["Safari", "Wildlife"], tbc: ["Flights TBC"] },
            { number: "03", flag: "After the wedding · Tanzania", name: "Ngorongoro", duration: "Around 3 days", desc: "The Ngorongoro Highlands — Maasai region, culture, and a UNESCO World Heritage volcanic crater teeming with wildlife.", tags: ["Maasai Culture", "Highlands"], tbc: ["Details TBC"] },
            { number: "04", flag: "After the wedding · Tanzania", name: "Zanzibar", duration: "Around one week", desc: "Beach and relaxation on the spice island. White sands, turquoise water, and the winding alleys of Stone Town.", tags: ["Beach", "Relaxation"], tbc: ["Accommodation TBC"] },
            { number: "05", flag: "Optional · Tanzania", name: "Kilimanjaro", duration: "Around one week", desc: "For the adventurous — trekking Africa's highest peak. Entirely optional and only for those who wish to join.", tags: ["Trekking", "Optional"], tbc: [] },
        ],
    },
    qa: {
