export const en = {
    ...
    travel: {
        ...
        note: "We'll keep this page updated with what we've booked and what we're still planning. Everyone books flights, accommodation, and activities independently. Soon you'll be able to indicate which parts you're interested in — this helps us get a sense of group sizes for things like shared transport between legs or crater rim hikes.",
        destinations: [
            {
                number: "01",
    ...
    qa: {
        ...
        categories: [
            ...
            },
            {
                label: "Zambia",
                items: [
                    { q: "How do I fly to Lusaka?", a: "From Munich and Switzerland, popular routes to Lusaka go via Addis Ababa (Ethiopian Airlines), Istanbul (Turkish Airlines), or Johannesburg. There is no direct flight — one or two stops are normal. There may be other options depending on your dates, so it's always worth checking flight search engines for the best combination of price and travel time. Book early — September is peak travel season." },
