    ...
    travel: {
        ...
        destinations: [
            ...
            },
            {
                ...
                highlights: [],
                itinerary: [
                    { date: "15 Sep", title: "Flight: Lusaka → Dar es Salaam", detail: "LUS → DAR · 15:05–18:25 · ~CHF 203 p.p.", status: "booked", note: "" },
                    { date: "15–16 Sep", title: "Night in Dar es Salaam", detail: "", status: "open", note: "" },
                    { date: "16 Sep", title: "Flight: Dar es Salaam → Serengeti", detail: "DAR → SEU via Arusha · 08:00–10:45 · ~CHF 158 p.p.", status: "booked", note: "" },
                    { date: "16–20 Sep", title: "Safari Lodge, Seronera", detail: "3 full days in the central Serengeti area", status: "open", note: "" },
                ],
            ...
            },
            {
                ...
                tbc: [],
                itinerary: [
                    { date: "20 Sep", title: "Drive: Seronera → Karatu", detail: "~4–5 hrs · game viewing en route · if we're travelling as a group we can organise shared jeeps to keep costs down per person", status: "open", note: "" },
                    { date: "20–22 Sep", title: "Patamu Restaurant, Lodge & Safaris, Karatu", detail: "2 nights in the highlands", status: "booked", note: "" },
                    ...
                    { date: "21 Sep", title: "Maasai village visit", detail: "Walking safari or Boma visit", status: "open", note: "A visit to a local Maasai Boma — a traditional family compound — to meet the community, learn about their way of life, and see the highlands from a very different perspective." },
                    { date: "22 Sep", title: "Drive to Arusha + Flight to Zanzibar", detail: "Details to follow · shared transport can be arranged for groups", status: "open", note: "" },
                ],
            },
            {
                number: "04",
